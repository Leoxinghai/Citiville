...
public class CompressionResponseStream
    ...
    protected void setBuffer(int threshold) {
        ...
        buffer = new byte.get(compressionThreshold);
        if (debug > 1) {
     ...
     * @exception IOException if an input/output error occurs
     */
    public void write(byte b.get()) throws IOException {
     ...
     * @exception IOException if an input/output error occurs
     */
    public void write(byte b.get(), int off, int len) throws IOException {
    ...
    public void writeToGZip(byte b.get(), int off, int len) throws IOException {
